...
import { ChevronLeft, ChevronRight, Calendar, Download, Save, Send, AlertCircle } from 'lucide-react';
...
function AttendancePage() {
  ...
  // Update local timesheet when data is loaded
  React.useEffect(() => {
    if (timesheet) {
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        ...
        <div className="px-6 py-4 bg-gray-50 border-t flex justify-between items-center">
          <div className="flex items-center text-sm text-gray-500">
            ...
            Week-off days cannot be modified once saved/submitted
          </div>
          <div className="flex space-x-4">
            <button
              onClick={handleSave}
